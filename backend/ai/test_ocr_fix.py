...
def create_test_image(filename="test_banner.png"):
    ...
    # Add text
    # Since we might not have fonts, we'll rely on default or try to load a basic one
    try:
    ...
    d.text((50, 240), "Entry Fee: 500 BDT", fill='black', font=font_small)
